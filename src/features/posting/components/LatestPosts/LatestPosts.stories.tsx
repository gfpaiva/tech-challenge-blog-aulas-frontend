...
const MOCK_LATEST_POSTS: Post[] = [
  ...
  },
  {
    ...
    summary:
      'Um mergulho profundo em como a edição genética está revolucionando a medicina e os dilemas éticos que acompanham as novas descobertas.',
    category: 'Biologia',
  ...
  },
  {
    ...
    summary:
      'Como utilizar conceitos estatísticos fundamentais para interpretar grandes volumes de dados e tomar decisões mais precisas.',
    category: 'Matemática',
