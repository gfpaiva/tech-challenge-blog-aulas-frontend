...
describe('PostMapper', () => {
  const validBasePayload = {
    ...
    content:
      'This is a long test content that should be summarized if it exceeds 120 characters to see if the summary feature works as intended by appending ellipses at the end.',
    author: {
      id: 'author-1',
      name: 'John Doe',
      role: 'Teacher',
